...
plt.figure()
sns.set_style(style)
count_sorted = count_sorted[count_sorted['source'] != 'mirbh_length_cutoff']
sns.barplot(data=count_sorted, y='species', x='count', hue='source', orient='h', hue_order=['mirgenedb', 'ncortho'])
plt.tight_layout()
