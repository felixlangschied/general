...
spec_dir = '/home/felixl/PycharmProjects/general/def_benchmark/data/spec_specific'

ncortho = True
res_dir = '/home/felixl/project/ncOrtho/benchmark/ncortho'
outf = '/home/felixl/PycharmProjects/general/def_benchmark/scripts/blast_results_in_mirgenedb.json'
...
def run_blast(mirf):
    ...
    species = species.replace('Sarcophilus_harrissii', 'Sarcophilus_harrisii')
    species = species.replace('Canis_familiaris', 'Canis_lupus_familiaris')
    species = species.replace('Strongylocentrotus_purpuratus_', 'Strongylocentrotus_purpuratus')
    ...
    if not os.path.isfile(results):
        print(f'WARNING: No file found for {species}')
        return False, False
    res_count = 0
